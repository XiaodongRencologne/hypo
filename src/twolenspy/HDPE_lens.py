...
import numpy as np
from hypo import coordinate,field_storage
#from Kirchhoffpy.Vopy import CO,dotproduct,vector
from hypo.vecops import Vector, dot #CO,dotproduct,vector
...
class HDEP_2lens():
    def __init__(self, 
        ...
        # 3. define lens
        L1_surface1 = surfacev2.RotationalSurface(profile_file=srffolder + 'lens1_plano.rsf', units=  'mm')
        L1_surface2 = surfacev2.RotationalSurface(profile_file=srffolder + 'lens1_f1.rsf', units=  'mm')
        ...
        L2_surface1 = surfacev2.RotationalSurface(profile_file=srffolder + 'lens2_plano.rsf', units=  'mm')
        L2_surface2 = surfacev2.RotationalSurface(profile_file=srffolder + 'lens2_f1.rsf', units=  'mm')
